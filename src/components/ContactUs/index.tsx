...
import { Mail, ChevronRight, Settings, MailIcon } from 'lucide-react'
    ...
    <div className="bg-white">
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <p className="text-gray-700 mb-4 text-[15px]">
          We&apos;re here to connect with our readers, answer questions, and keep improving our
          explainers and voting polls.If you have feedback, corrections, partnership inquiries, or
          technical issues — we&apos;d love to hear from you.But if you&apos;re here to waste our
          time… don’t. 😄
        </p>
        <u className="text-root flex gap-2 mb-6">
          <MailIcon />
          support@askgeopolitics.com
        </u>

        {/* Social Media Section */}
        <div className="mb-8">
          <h2 className="font-bold text-gray-900 mb-4 text-lg">Our Social Media</h2>
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
          ...
          <p className="text-[14px] text-gray-700 mb-6">
            Your insights help us improve our Q&A explainers and our interactive voting polls.  If
            there&apos;s a feature you&apos;d like us to build, a news format you prefer, or a
            question you want answered, let us know — we listen.
          </p>
          <span className='mt-6 font-medium'>(And yes, we’ll reply faster than WhatsApp. 😉)</span>
        </div>
      </div>
    </div>
  )
